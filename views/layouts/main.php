    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="<?= Url::to(["public/images/logo.jpg"]) ?>" alt=""></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="<?= Url::to(['public/images/logo2.png']) ?>" alt=""></div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <img src="<?= Url::to(["public/images/author.png"]) ?>" alt="">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <a href="#"><img src="<?= Url::to(["public/images/footer-img.png"]) ?>" alt=""></a>
                        </div>
                        <div>
